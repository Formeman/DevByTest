...
public class StaticDevBy {
    StaticLoginPage loginPage ;
    StaticMainPage mainPage;
    StaticVacancyPage vacancyPage;
    WebDriver driver;
    StaticNewsPage newsPage;
    StaticEventsPage eventsPage;

    @BeforeMethod(alwaysRun = true)
    public void BeforeMethod() {
        driver = WebDriverSingleton.create();
        loginPage = new StaticLoginPage();
        mainPage = new StaticMainPage();
        vacancyPage = new StaticVacancyPage();
        newsPage = new StaticNewsPage();
        eventsPage = new StaticEventsPage();
